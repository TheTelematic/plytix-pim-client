def test_get_attribute(client, new_product_attribute_data):
    product_attribute = client.products.attributes.create_attribute(**new_product_attribute_data)

    retrieved_product_attribute = client.products.attributes.get_attribute(product_attribute.id)
...
def test_get_attribute_that_does_not_exist(client):
    product_attribute = client.products.attributes.get_attribute("non_existent_id")
    assert product_attribute is None


def test_get_attributes(client, new_product_attribute_data):
    ...
    retrieved_product_attributes = client.products.attributes.get_attributes(
