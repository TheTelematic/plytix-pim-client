def test_update_relationship(plytix, new_product_relationship_data):
    relationship = plytix.products.relationships.create_product_relationship(**new_product_relationship_data)

    updated_relationship = plytix.products.relationships.update_relationship(
        relationship.id,
...
def test_update_not_existing_relationship(plytix):
    updated_relationship = plytix.products.relationships.update_relationship(
...
def test_update_relationships(plytix, new_product_relationship_data):
    ...
    updated_relationships = plytix.products.relationships.update_relationships(
        [
