...
async def test_search_product_attributes_groups(plytix, new_product_attributes_group_data):
    ...
    await plytix.products.attributes.groups.create_attributes_groups(product_attributes_groups)

    search_results = await plytix.products.attributes.groups.search_product_attributes_groups(
        filters=[
            [
                SearchFilter(
...
async def test_search_all_product_attributes_groups(plytix, new_product_attributes_group_data):
    new_product_attributes_group_data_1 = new_product_attributes_group_data.copy()
    new_product_attributes_group_data_2 = new_product_attributes_group_data.copy()
    new_product_attributes_group_data_3 = new_product_attributes_group_data.copy()
    ...
    search_results = []
    async for product_attributes_groups in plytix.products.attributes.groups.search_all_product_attributes_groups(
        filters=[
            [
                SearchFilter(
                    field="name", operator=OperatorEnum.CONTAINS, value=new_product_attributes_group_data["name"]
