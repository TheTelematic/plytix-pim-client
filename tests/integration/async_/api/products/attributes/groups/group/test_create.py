async def test_create_product_attributes_group(plytix, new_product_attributes_group_data):
...
async def test_create_multiple_product_attributes_groups(plytix, new_product_attributes_group_data):
    ...
    product_attributes_groups = await plytix.products.attributes.groups.create_attributes_groups(
