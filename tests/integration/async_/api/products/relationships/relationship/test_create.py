async def test_create_product_relationship(plytix, new_product_relationship_data):
...
async def test_create_product_relationships(plytix, new_product_relationship_data):
    ...
    product_relationships = await plytix.products.relationships.create_product_relationships(
