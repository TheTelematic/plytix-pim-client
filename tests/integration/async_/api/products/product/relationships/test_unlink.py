...
async def test_unlink_relationship_to_product(plytix, product, product_relationship, new_product_data):
    ...
    result = await plytix.products.relationships.unlink_product_from_relationship(
...
async def test_multiple_products_to_relationships(
    ...
    await plytix.products.relationships.link_product_to_relationships(
        [
            {
    ...
    results = await plytix.products.relationships.unlink_product_from_relationships(
        [
            {
                "product_id": product.id,
                "product_relationship_id": product_relationship.id,
