...
async def test_link_attribute_to_family(plytix, new_product_family_data, new_product_attribute_data):
...
async def test_link_attributes_to_families(plytix, new_product_family_data, new_product_attribute_data):
    ...
    attributes1 = await plytix.products.families.attributes.get_family_attributes(new_family1.id)
    attributes2 = await plytix.products.families.attributes.get_family_attributes(new_family2.id)
