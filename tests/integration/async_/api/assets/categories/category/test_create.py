...
async def test_create_asset_subcategory(plytix, new_asset_category_data):
    parent_category = await plytix.assets.categories.create_asset_category(**new_asset_category_data)
...
async def test_create_asset_subcategories(plytix, new_asset_category_data):
    parent_category = await plytix.assets.categories.create_asset_category(**new_asset_category_data)
