...
async def test_sorting_category(plytix, asset_category, asset_subcategory, new_asset_category_data):
    asset_subcategory2 = new_asset_category_data.copy()
    asset_subcategory2["name"] = f"{asset_subcategory2['name']}-sub2"
    asset_subcategory2 = await plytix.assets.categories.create_asset_category(
    ...
    categories = [
        _
        async for _ in plytix.assets.categories.search_all_asset_categories(
            [
                [
                    SearchFilter(
                        field="id",
...
async def test_sorting_root_category(plytix, asset_category, new_asset_category_data):
    asset_category2 = new_asset_category_data.copy()
    asset_category2["name"] = f"{asset_category2['name']}-sub2"
    asset_category2 = await plytix.assets.categories.create_asset_category(**asset_category2)
