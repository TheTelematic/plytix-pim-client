...
def test_create_asset_from_url(
    ...
    plytix.assets.create_asset_by_url(**data)
...
def test_create_assets_from_urls(
    plytix_factory, response_factory, assert_requests_factory, new_asset_data_from_url_factory
):
    ...
    plytix.assets.create_assets_by_urls([data1, data2])
...
def test_create_asset_from_local_file(plytix_factory, new_asset_data_from_local_file_factory):
    assert False


@pytest.mark.skip("To be fixed in https://github.com/TheTelematic/plytix-pim-client/issues/26")
def test_create_assets_from_local_files(plytix_factory, new_asset_data_from_local_file_factory):
    assert False
