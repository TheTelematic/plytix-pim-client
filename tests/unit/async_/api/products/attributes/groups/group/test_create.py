async def test_create_product_attributes_group(plytix_factory, new_product_attributes_group_data):
...
async def test_create_multiple_product_attributes_groups(plytix_factory, new_product_attributes_group_data):
    ...
    product_attributes_groups = await plytix_factory.products.attributes.groups.create_attributes_groups(
