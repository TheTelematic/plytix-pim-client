async def test_create_product_attribute(plytix_factory, new_product_attribute_data):
...
async def test_create_multiple_product_attributes(plytix_factory, new_product_attribute_data):
    ...
    product_attributes = await plytix_factory.products.attributes.create_attributes(
