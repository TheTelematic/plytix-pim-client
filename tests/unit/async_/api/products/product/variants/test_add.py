async def test_add_new_variant_to_product(
    ...
    result = await plytix_factory.products.variants.add_variant_to_product(product.id, new_product_data["sku"])
...
async def test_add_new_variant_to_product_with_label(
    ...
    result = await plytix_factory.products.variants.add_variant_to_product(
...
async def test_add_new_variant_to_product_not_found(plytix_factory):
    result = await plytix_factory.products.variants.add_variant_to_product("not_found", "not_found")
...
async def test_add_new_variants_to_products(
    ...
    result = await plytix_factory.products.variants.add_variant_to_products(
        [
            (
                product.id,
...
async def test_add_new_variants_to_products_not_found(plytix_factory):
    result = await plytix_factory.products.variants.add_variant_to_products(
