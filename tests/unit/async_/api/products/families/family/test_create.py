async def test_create_family_ok(plytix_factory, new_product_family_data):
...
async def test_create_family_multiple_ok(plytix_factory, new_product_family_data):
    ...
    families = await plytix_factory.products.families.create_families([family1, family2])
