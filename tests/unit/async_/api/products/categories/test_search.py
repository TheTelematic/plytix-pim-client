...
async def test_search_product_categories(plytix_factory, new_product_category_data):
    ...
    categories = await plytix_factory.products.categories.create_product_categories(
        [new_product_data_1, new_product_data_2, new_product_data_3]
    )

    search_results = await plytix_factory.products.categories.search_product_categories(
...
async def test_search_all_product_categories(plytix_factory, new_product_category_data):
    new_product_data_1 = new_product_category_data.copy()
    new_product_data_2 = new_product_category_data.copy()
    new_product_data_3 = new_product_category_data.copy()
    new_product_data_1["name"] = f"{new_product_data_1['name']}-1"
    ...
    search_results = []
    async for results in plytix_factory.products.categories.search_all_product_categories(
        filters=[[SearchFilter(field="id", operator=OperatorEnum.IN, value=[category.id for category in categories])]],
        attributes=[
            "modified",
        ],
