...
class ProductCategoriesSearchAPISyncMixin(BaseAPISyncMixin):
    def search_product_categories(
        ...
        *,
        ...
        return ProductCategoriesSearchAPI.process_search_response(
            response,
    ...
    def search_all_product_categories(
        ...
        while True:
            ...
            product_categories = cast(
                List[ProductCategory],
                self.search_product_categories(filters, attributes, relationship_filters, pagination),
            )
...
class ProductCategoriesSearchAPIAsyncMixin(BaseAPIAsyncMixin):
    ...
    async def search_all_product_categories(
        ...
        while True:
            ...
            product_categories = cast(
                List[ProductCategory],
                await self.search_product_categories(filters, attributes, relationship_filters, pagination),
            )
            if not product_categories:
                break
            yield product_categories
